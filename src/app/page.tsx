        ...
        <div className="text-center max-w-6xl mx-auto relative z-40">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 inline-flex items-center gap-2 shadow-2xl hover:shadow-blue-500/25"
            >
              {/* Button shine effect */}
              <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                We don&apos;t just install bots—we build tailored systems that
                think, respond, and drive ROI.
              </p>
      ...
      <section className="relative py-24 px-4 bg-gradient-to-b from-transparent to-gray-900/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative overflow-hidden">
            ...
            <motion.div
              className="flex gap-12 py-8 mb-8 w-[200%]"
              animate={{
                x: [0, -1200],
              }}
              transition={{
            ...
            <motion.div
              className="flex gap-12 py-8 w-[200%]"
              animate={{
                x: [-1200, 0],
              }}
              transition={{
      ...
      <section className="relative py-32 px-4 bg-gradient-to-b from-transparent to-gray-900/20">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Get answers to common questions about AI agents and how they can
          ...
          <div className="space-y-4">
            <FAQItem
              ...
              answer="Most AI voice agents can be deployed within 2-3 weeks, including custom training on your business data, testing, and integration with your existing systems. Chat agents can often be ready in 1-2 weeks. The timeline depends on complexity and the number of integrations required."
              delay={0.1}
            />
            <FAQItem
              question="What's the ROI of implementing AI agents?"
              answer="Businesses typically see ROI within 30-90 days. Common benefits include 40-60% increase in lead capture, 24/7 availability, reduced staffing costs, and improved customer satisfaction. Many clients report the system paying for itself within the first month through increased bookings alone."
              delay={0.2}
            />
            <FAQItem
              question="Do AI agents sound robotic or natural?"
              answer="Our AI voice agents use advanced speech synthesis and are trained to sound completely natural. They can handle complex conversations, understand context, use your brand voice, and even pause naturally. Most customers cannot tell they're speaking with an AI agent."
              delay={0.3}
            />
            <FAQItem
              question="Can AI agents integrate with my existing CRM and tools?"
              answer="Yes! Our AI agents integrate with popular CRMs (Salesforce, HubSpot, Pipedrive), calendars (Google, Outlook), phone systems, and hundreds of other tools via Zapier, Make, and direct APIs. We ensure seamless data flow into your existing workflow."
              delay={0.4}
            />
            <FAQItem
              question="What happens if the AI agent doesn't know how to respond?"
              answer="Our agents are trained with fallback protocols. If they encounter a question outside their knowledge, they can gracefully transfer to a human agent, take a detailed message, or schedule a callback. We also continuously update their knowledge base based on real interactions."
              delay={0.5}
            />
            <FAQItem
              question="How much do AI agent solutions cost?"
              answer="Pricing varies based on your needs, but most businesses invest $2,000-$10,000 for setup and $200-$1,500/month for hosting and support. Given that businesses typically see $5,000-$15,000+ in additional monthly revenue, the ROI is substantial. Contact us for a custom quote."
              delay={0.6}
            />
            <FAQItem
              question="Are AI agents secure and HIPAA compliant?"
              answer="Yes, we implement enterprise-grade security including data encryption, secure hosting, and compliance frameworks. For healthcare clients, we can provide HIPAA-compliant solutions with proper business associate agreements and security protocols."
              delay={0.7}
            />
            <FAQItem
              question="Can I customize the AI agent's personality and responses?"
              answer="Absolutely! We train each agent with your specific brand voice, terminology, and personality. Whether you want professional, friendly, casual, or industry-specific language, we customize everything to match your business culture and customer expectations."
              delay={0.8}
            />
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-2xl text-gray-300 mb-12 leading-relaxed">
              ...
              revenue, reduce costs, and deliver exceptional customer
              experiences 24/7.
            </p>
          </motion.div>
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold text-lg py-5 px-10 rounded-full transition-all duration-300 inline-flex items-center gap-3 shadow-2xl hover:shadow-blue-500/25 min-w-[280px]"
            >
